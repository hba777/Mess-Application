...
export default function AddUser() {
  ...
  const [pmaCourse, setPmaCourse] = useState("");
  ...
  return (
    <div className="p-4 relative max-w-3xl min-h-full mx-auto">
      <div className="p-4 max-w-3xl mx-auto relative">
        ...
        <h1 className="text-3xl font-bold font-serif text-center w-full text-slate-200">Add New User</h1>
      </div>
      <div className="space-y-4">
        <div className="bg-slate-200 p-4 rounded-lg shadow-md flex flex-col items-center">
          <form onSubmit={handleSubmit} className="w-full max-w-md">
            {[{ id: "cmsid", label: "CMS ID", state: cmsid, setState: setCmsid },
              ...
              { id: "pmaCourse", label: "PMA Course", state: pmaCourse, setState: setPmaCourse },
              { id: "degree", label: "Degree", state: degree, setState: setDegree },
              { id: "phoneNumber", label: "Phone Number", state: phoneNumber, setState: setPhoneNumber }].map((field) => (
